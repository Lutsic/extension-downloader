const EXTENSIONS_DATA = [
    ...
    { id: "mnjggcdmjocbbbhaepdhchncahnbgone", title: "SponsorBlock", desc: "Skip sponsorships, subscription begging and more on YouTube videos.", img: "img/50.png", category: "utils" },
    { id: "pihphjfnfjmdbhakhjifipfdgbpenobg", title: "DocsAfterDark", desc: "Beyond dark mode for Google Docs", img: "img/51.png", category: "utils" },
    { id: "jephanpkonkmnkekmlkcijdjgniikppl", title: "VK Next - functions for VK", desc: "The best add-on for VK with many features, some of which are exclusive.", img: "img/52.png", category: "utils" },
    { id: "kjnmdomccekpkjomjhapnilfmeiglkid", title: "Web for Telegram", desc: "Easy access to Telegram for Chrome.", img: "img/53.png", category: "utils" },
